...
for i = 1:num_runs
    ...
    ii_results.num_nogo = ii_results.num_nogo + ii_stats_vgs(i).num_nogo;
end
...
for i = 1:num_runs
    ...
    ii_results.num_bfix = ii_results.num_bfix + ii_stats_vgs(i).num_fix_breaks;
end
...
for j = 1:num_runs
    % Error
    ii_results.all_primary_err_x = [ii_results.all_primary_err_x; ii_stats_vgs(j).good_primary_err_x];
    ii_results.all_primary_err_y = [ii_results.all_primary_err_y; ii_stats_vgs(j).good_primary_err_y];
    ii_results.all_primary_err_z = [ii_results.all_primary_err_z; ii_stats_vgs(j).good_primary_err_z];

    ii_results.all_final_err_x = [ii_results.all_final_err_x; ii_stats_vgs(j).good_final_err_x];
    ii_results.all_final_err_y = [ii_results.all_final_err_y; ii_stats_vgs(j).good_final_err_y];
    ii_results.all_final_err_z = [ii_results.all_final_err_z; ii_stats_vgs(j).good_final_err_z];
    
    % Gain
    ii_results.all_primary_gain_x = [ii_results.all_primary_gain_x; ii_stats_vgs(j).good_primary_gain_x];
    ii_results.all_primary_gain_y = [ii_results.all_primary_gain_y; ii_stats_vgs(j).good_primary_gain_y];
    ii_results.all_primary_gain_z = [ii_results.all_primary_gain_z; ii_stats_vgs(j).good_primary_gain_z];
    
    ii_results.all_final_gain_x = [ii_results.all_final_gain_x; ii_stats_vgs(j).good_final_gain_x];
    ii_results.all_final_gain_y = [ii_results.all_final_gain_y; ii_stats_vgs(j).good_final_gain_y];
    ii_results.all_final_gain_z = [ii_results.all_final_gain_z; ii_stats_vgs(j).good_final_gain_z];
    
    % SRT
    
    ii_results.all_srt = [ii_results.all_srt; ii_stats_vgs(j).good_srt];
end

% Left trials
for j = 1:num_runs
    % Error
    ii_results.all_left_primary_err_x = [ii_results.all_left_primary_err_x; ii_stats_vgs(j).left_primary_err_x];
    ii_results.all_left_primary_err_y = [ii_results.all_left_primary_err_y; ii_stats_vgs(j).left_primary_err_y];
    ii_results.all_left_primary_err_z = [ii_results.all_left_primary_err_z; ii_stats_vgs(j).left_primary_err_z];

    ii_results.all_left_final_err_x = [ii_results.all_left_final_err_x; ii_stats_vgs(j).left_final_err_x];
    ii_results.all_left_final_err_y = [ii_results.all_left_final_err_y; ii_stats_vgs(j).left_final_err_y];
    ii_results.all_left_final_err_z = [ii_results.all_left_final_err_z; ii_stats_vgs(j).left_final_err_z];
    
    % Gain
    ii_results.all_left_primary_gain_x = [ii_results.all_left_primary_gain_x; ii_stats_vgs(j).left_primary_gain_x];
    ii_results.all_left_primary_gain_y = [ii_results.all_left_primary_gain_y; ii_stats_vgs(j).left_primary_gain_y];
    ii_results.all_left_primary_gain_z = [ii_results.all_left_primary_gain_z; ii_stats_vgs(j).left_primary_gain_z];
    
    ii_results.all_left_final_gain_x = [ii_results.all_left_final_gain_x; ii_stats_vgs(j).left_final_gain_x];
    ii_results.all_left_final_gain_y = [ii_results.all_left_final_gain_y; ii_stats_vgs(j).left_final_gain_y];
    ii_results.all_left_final_gain_z = [ii_results.all_left_final_gain_z; ii_stats_vgs(j).left_final_gain_z];
    
    % SRT
    
    ii_results.all_left_srt = [ii_results.all_left_srt; ii_stats_vgs(j).left_srt];
end

% Right trials
for j = 1:num_runs
    % Error
    ii_results.all_right_primary_err_x = [ii_results.all_right_primary_err_x; ii_stats_vgs(j).right_primary_err_x];
    ii_results.all_right_primary_err_y = [ii_results.all_right_primary_err_y; ii_stats_vgs(j).right_primary_err_y];
    ii_results.all_right_primary_err_z = [ii_results.all_right_primary_err_z; ii_stats_vgs(j).right_primary_err_z];

    ii_results.all_right_final_err_x = [ii_results.all_right_final_err_x; ii_stats_vgs(j).right_final_err_x];
    ii_results.all_right_final_err_y = [ii_results.all_right_final_err_y; ii_stats_vgs(j).right_final_err_y];
    ii_results.all_right_final_err_z = [ii_results.all_right_final_err_z; ii_stats_vgs(j).right_final_err_z];
    
    % Gain
    ii_results.all_right_primary_gain_x = [ii_results.all_right_primary_gain_x; ii_stats_vgs(j).right_primary_gain_x];
    ii_results.all_right_primary_gain_y = [ii_results.all_right_primary_gain_y; ii_stats_vgs(j).right_primary_gain_y];
    ii_results.all_right_primary_gain_z = [ii_results.all_right_primary_gain_z; ii_stats_vgs(j).right_primary_gain_z];
    
    ii_results.all_right_final_gain_x = [ii_results.all_right_final_gain_x; ii_stats_vgs(j).right_final_gain_x];
    ii_results.all_right_final_gain_y = [ii_results.all_right_final_gain_y; ii_stats_vgs(j).right_final_gain_y];
    ii_results.all_right_final_gain_z = [ii_results.all_right_final_gain_z; ii_stats_vgs(j).right_final_gain_z];
    
    % SRT
    
    ii_results.all_right_srt = [ii_results.all_right_srt; ii_stats_vgs(j).right_srt];
end
...
for j = 1:num_runs
    % Error
    ii_results.no_break_primary_err_x = [ii_results.no_break_primary_err_x; ii_stats_vgs(j).no_break_primary_err_x];
    ii_results.no_break_primary_err_y = [ii_results.no_break_primary_err_y; ii_stats_vgs(j).no_break_primary_err_y];
    ii_results.no_break_primary_err_z = [ii_results.no_break_primary_err_z; ii_stats_vgs(j).no_break_primary_err_z];

    ii_results.no_break_final_err_x = [ii_results.no_break_final_err_x; ii_stats_vgs(j).no_break_final_err_x];
    ii_results.no_break_final_err_y = [ii_results.no_break_final_err_y; ii_stats_vgs(j).no_break_final_err_y];
    ii_results.no_break_final_err_z = [ii_results.no_break_final_err_z; ii_stats_vgs(j).no_break_final_err_z];
    
    % Gain
    ii_results.no_break_primary_gain_x = [ii_results.no_break_primary_gain_x; ii_stats_vgs(j).no_break_primary_gain_x];
    ii_results.no_break_primary_gain_y = [ii_results.no_break_primary_gain_y; ii_stats_vgs(j).no_break_primary_gain_y];
    ii_results.no_break_primary_gain_z = [ii_results.no_break_primary_gain_z; ii_stats_vgs(j).no_break_primary_gain_z];
    
    ii_results.no_break_final_gain_x = [ii_results.no_break_final_gain_x; ii_stats_vgs(j).no_break_final_gain_x];
    ii_results.no_break_final_gain_y = [ii_results.no_break_final_gain_y; ii_stats_vgs(j).no_break_final_gain_y];
    ii_results.no_break_final_gain_z = [ii_results.no_break_final_gain_z; ii_stats_vgs(j).no_break_final_gain_z];
    
    % SRT    
    ii_results.no_break_srt = [ii_results.no_break_srt; ii_stats_vgs(j).no_break_srt];
end

% Left trials
for j = 1:num_runs
    % Error
    ii_results.no_break_left_primary_err_x = [ii_results.no_break_left_primary_err_x; ii_stats_vgs(j).no_break_left_primary_err_x];
    ii_results.no_break_left_primary_err_y = [ii_results.no_break_left_primary_err_y; ii_stats_vgs(j).no_break_left_primary_err_y];
    ii_results.no_break_left_primary_err_z = [ii_results.no_break_left_primary_err_z; ii_stats_vgs(j).no_break_left_primary_err_z];

    ii_results.no_break_left_final_err_x = [ii_results.no_break_left_final_err_x; ii_stats_vgs(j).no_break_left_final_err_x];
    ii_results.no_break_left_final_err_y = [ii_results.no_break_left_final_err_y; ii_stats_vgs(j).no_break_left_final_err_y];
    ii_results.no_break_left_final_err_z = [ii_results.no_break_left_final_err_z; ii_stats_vgs(j).no_break_left_final_err_z];
    
    % Gain
    ii_results.no_break_left_primary_gain_x = [ii_results.no_break_left_primary_gain_x; ii_stats_vgs(j).no_break_left_primary_gain_x];
    ii_results.no_break_left_primary_gain_y = [ii_results.no_break_left_primary_gain_y; ii_stats_vgs(j).no_break_left_primary_gain_y];
    ii_results.no_break_left_primary_gain_z = [ii_results.no_break_left_primary_gain_z; ii_stats_vgs(j).no_break_left_primary_gain_z];
    
    ii_results.no_break_left_final_gain_x = [ii_results.no_break_left_final_gain_x; ii_stats_vgs(j).no_break_left_final_gain_x];
    ii_results.no_break_left_final_gain_y = [ii_results.no_break_left_final_gain_y; ii_stats_vgs(j).no_break_left_final_gain_y];
    ii_results.no_break_left_final_gain_z = [ii_results.no_break_left_final_gain_z; ii_stats_vgs(j).no_break_left_final_gain_z];
    
    % SRT    
    ii_results.no_break_left_srt = [ii_results.no_break_left_srt; ii_stats_vgs(j).no_break_left_srt];
end

% Right trials
for j = 1:num_runs
    % Error
    ii_results.no_break_right_primary_err_x = [ii_results.no_break_right_primary_err_x; ii_stats_vgs(j).no_break_right_primary_err_x];
    ii_results.no_break_right_primary_err_y = [ii_results.no_break_right_primary_err_y; ii_stats_vgs(j).no_break_right_primary_err_y];
    ii_results.no_break_right_primary_err_z = [ii_results.no_break_right_primary_err_z; ii_stats_vgs(j).no_break_right_primary_err_z];

    ii_results.no_break_right_final_err_x = [ii_results.no_break_right_final_err_x; ii_stats_vgs(j).no_break_right_final_err_x];
    ii_results.no_break_right_final_err_y = [ii_results.no_break_right_final_err_y; ii_stats_vgs(j).no_break_right_final_err_y];
    ii_results.no_break_right_final_err_z = [ii_results.no_break_right_final_err_z; ii_stats_vgs(j).no_break_right_final_err_z];
    
    % Gain
    ii_results.no_break_right_primary_gain_x = [ii_results.no_break_right_primary_gain_x; ii_stats_vgs(j).no_break_right_primary_gain_x];
    ii_results.no_break_right_primary_gain_y = [ii_results.no_break_right_primary_gain_y; ii_stats_vgs(j).no_break_right_primary_gain_y];
    ii_results.no_break_right_primary_gain_z = [ii_results.no_break_right_primary_gain_z; ii_stats_vgs(j).no_break_right_primary_gain_z];
    
    ii_results.no_break_right_final_gain_x = [ii_results.no_break_right_final_gain_x; ii_stats_vgs(j).no_break_right_final_gain_x];
    ii_results.no_break_right_final_gain_y = [ii_results.no_break_right_final_gain_y; ii_stats_vgs(j).no_break_right_final_gain_y];
    ii_results.no_break_right_final_gain_z = [ii_results.no_break_right_final_gain_z; ii_stats_vgs(j).no_break_right_final_gain_z];
    
    % SRT    
    ii_results.no_break_right_srt = [ii_results.no_break_right_srt; ii_stats_vgs(j).no_break_right_srt];
end
...
for j = 1:num_runs
    % Error
    ii_results.only_break_primary_err_x = [ii_results.only_break_primary_err_x; ii_stats_vgs(j).only_break_primary_err_x];
    ii_results.only_break_primary_err_y = [ii_results.only_break_primary_err_y; ii_stats_vgs(j).only_break_primary_err_y];
    ii_results.only_break_primary_err_z = [ii_results.only_break_primary_err_z; ii_stats_vgs(j).only_break_primary_err_z];

    ii_results.only_break_final_err_x = [ii_results.only_break_final_err_x; ii_stats_vgs(j).only_break_final_err_x];
    ii_results.only_break_final_err_y = [ii_results.only_break_final_err_y; ii_stats_vgs(j).only_break_final_err_y];
    ii_results.only_break_final_err_z = [ii_results.only_break_final_err_z; ii_stats_vgs(j).only_break_final_err_z];
    
    % Gain
    ii_results.only_break_primary_gain_x = [ii_results.only_break_primary_gain_x; ii_stats_vgs(j).only_break_primary_gain_x];
    ii_results.only_break_primary_gain_y = [ii_results.only_break_primary_gain_y; ii_stats_vgs(j).only_break_primary_gain_y];
    ii_results.only_break_primary_gain_z = [ii_results.only_break_primary_gain_z; ii_stats_vgs(j).only_break_primary_gain_z];
    
    ii_results.only_break_final_gain_x = [ii_results.only_break_final_gain_x; ii_stats_vgs(j).only_break_final_gain_x];
    ii_results.only_break_final_gain_y = [ii_results.only_break_final_gain_y; ii_stats_vgs(j).only_break_final_gain_y];
    ii_results.only_break_final_gain_z = [ii_results.only_break_final_gain_z; ii_stats_vgs(j).only_break_final_gain_z];
    
    % SRT    
    ii_results.only_break_srt = [ii_results.only_break_srt; ii_stats_vgs(j).only_break_srt];
end
...
for j = 1:num_runs
    % Error
%     ii_results.b1_all_primary_err_z = [ii_results.b1_all_primary_err_z; ii_stats_vgs(j).b1_primary_err_z];
%     ii_results.b2_all_primary_err_z = [ii_results.b2_all_primary_err_z; ii_stats_vgs(j).b2_primary_err_z];
%     ii_results.b3_all_primary_err_z = [ii_results.b3_all_primary_err_z; ii_stats_vgs(j).b3_primary_err_z];
%     ii_results.b4_all_primary_err_z = [ii_results.b4_all_primary_err_z; ii_stats_vgs(j).b4_primary_err_z];
%     ii_results.b5_all_primary_err_z = [ii_results.b5_all_primary_err_z; ii_stats_vgs(j).b5_primary_err_z];
%     ii_results.b6_all_primary_err_z = [ii_results.b6_all_primary_err_z; ii_stats_vgs(j).b6_primary_err_z];
%     ii_results.b7_all_primary_err_z = [ii_results.b7_all_primary_err_z; ii_stats_vgs(j).b7_primary_err_z];
%     ii_results.b8_all_primary_err_z = [ii_results.b8_all_primary_err_z; ii_stats_vgs(j).b8_primary_err_z];
%     
%     % Gain
%     ii_results.b1_all_primary_gain_z = [ii_results.b1_all_primary_gain_z; ii_stats_vgs(j).b1_primary_gain_z];
%     ii_results.b2_all_primary_gain_z = [ii_results.b2_all_primary_gain_z; ii_stats_vgs(j).b2_primary_gain_z];
%     ii_results.b3_all_primary_gain_z = [ii_results.b3_all_primary_gain_z; ii_stats_vgs(j).b3_primary_gain_z];
%     ii_results.b4_all_primary_gain_z = [ii_results.b4_all_primary_gain_z; ii_stats_vgs(j).b4_primary_gain_z];
%     ii_results.b5_all_primary_gain_z = [ii_results.b5_all_primary_gain_z; ii_stats_vgs(j).b5_primary_gain_z];
%     ii_results.b6_all_primary_gain_z = [ii_results.b6_all_primary_gain_z; ii_stats_vgs(j).b6_primary_gain_z];
%     ii_results.b7_all_primary_gain_z = [ii_results.b7_all_primary_gain_z; ii_stats_vgs(j).b7_primary_gain_z];
%     ii_results.b8_all_primary_gain_z = [ii_results.b8_all_primary_gain_z; ii_stats_vgs(j).b8_primary_gain_z];
%     
%     % SRT    
%     ii_results.b1_all_srt = [ii_results.b1_all_srt; ii_stats_vgs(j).b1_srt];
%     ii_results.b2_all_srt = [ii_results.b2_all_srt; ii_stats_vgs(j).b2_srt];
%     ii_results.b3_all_srt = [ii_results.b3_all_srt; ii_stats_vgs(j).b3_srt];
%     ii_results.b4_all_srt = [ii_results.b4_all_srt; ii_stats_vgs(j).b4_srt];
%     ii_results.b5_all_srt = [ii_results.b5_all_srt; ii_stats_vgs(j).b5_srt];
%     ii_results.b6_all_srt = [ii_results.b6_all_srt; ii_stats_vgs(j).b6_srt];
%     ii_results.b7_all_srt = [ii_results.b7_all_srt; ii_stats_vgs(j).b7_srt];
%     ii_results.b8_all_srt = [ii_results.b8_all_srt; ii_stats_vgs(j).b8_srt];

    ii_results.b1_no_break_primary_err_z = [ii_results.b1_no_break_primary_err_z; ii_stats_vgs(j).no_break_b1_primary_err_z];
    ii_results.b2_no_break_primary_err_z = [ii_results.b2_no_break_primary_err_z; ii_stats_vgs(j).no_break_b2_primary_err_z];
    ii_results.b3_no_break_primary_err_z = [ii_results.b3_no_break_primary_err_z; ii_stats_vgs(j).no_break_b3_primary_err_z];
    ii_results.b4_no_break_primary_err_z = [ii_results.b4_no_break_primary_err_z; ii_stats_vgs(j).no_break_b4_primary_err_z];
    ii_results.b5_no_break_primary_err_z = [ii_results.b5_no_break_primary_err_z; ii_stats_vgs(j).no_break_b5_primary_err_z];
    ii_results.b6_no_break_primary_err_z = [ii_results.b6_no_break_primary_err_z; ii_stats_vgs(j).no_break_b6_primary_err_z];
    ii_results.b7_no_break_primary_err_z = [ii_results.b7_no_break_primary_err_z; ii_stats_vgs(j).no_break_b7_primary_err_z];
    ii_results.b8_no_break_primary_err_z = [ii_results.b8_no_break_primary_err_z; ii_stats_vgs(j).no_break_b8_primary_err_z];
    
    % Gain
    ii_results.b1_no_break_primary_gain_z = [ii_results.b1_no_break_primary_gain_z; ii_stats_vgs(j).no_break_b1_primary_gain_z];
    ii_results.b2_no_break_primary_gain_z = [ii_results.b2_no_break_primary_gain_z; ii_stats_vgs(j).no_break_b2_primary_gain_z];
    ii_results.b3_no_break_primary_gain_z = [ii_results.b3_no_break_primary_gain_z; ii_stats_vgs(j).no_break_b3_primary_gain_z];
    ii_results.b4_no_break_primary_gain_z = [ii_results.b4_no_break_primary_gain_z; ii_stats_vgs(j).no_break_b4_primary_gain_z];
    ii_results.b5_no_break_primary_gain_z = [ii_results.b5_no_break_primary_gain_z; ii_stats_vgs(j).no_break_b5_primary_gain_z];
    ii_results.b6_no_break_primary_gain_z = [ii_results.b6_no_break_primary_gain_z; ii_stats_vgs(j).no_break_b6_primary_gain_z];
    ii_results.b7_no_break_primary_gain_z = [ii_results.b7_no_break_primary_gain_z; ii_stats_vgs(j).no_break_b7_primary_gain_z];
    ii_results.b8_no_break_primary_gain_z = [ii_results.b8_no_break_primary_gain_z; ii_stats_vgs(j).no_break_b8_primary_gain_z];
    
    % SRT    
    ii_results.b1_no_break_srt = [ii_results.b1_no_break_srt; ii_stats_vgs(j).no_break_b1_srt];
    ii_results.b2_no_break_srt = [ii_results.b2_no_break_srt; ii_stats_vgs(j).no_break_b2_srt];
    ii_results.b3_no_break_srt = [ii_results.b3_no_break_srt; ii_stats_vgs(j).no_break_b3_srt];
    ii_results.b4_no_break_srt = [ii_results.b4_no_break_srt; ii_stats_vgs(j).no_break_b4_srt];
    ii_results.b5_no_break_srt = [ii_results.b5_no_break_srt; ii_stats_vgs(j).no_break_b5_srt];
    ii_results.b6_no_break_srt = [ii_results.b6_no_break_srt; ii_stats_vgs(j).no_break_b6_srt];
    ii_results.b7_no_break_srt = [ii_results.b7_no_break_srt; ii_stats_vgs(j).no_break_b7_srt];
    ii_results.b8_no_break_srt = [ii_results.b8_no_break_srt; ii_stats_vgs(j).no_break_b8_srt];
...
dt_err = [median(ii_results.b1_no_break_primary_err_z); median(ii_results.b2_no_break_primary_err_z); median(ii_results.b3_no_break_primary_err_z); median(ii_results.b4_no_break_primary_err_z); median(ii_results.b5_no_break_primary_err_z); median(ii_results.b6_no_break_primary_err_z); median(ii_results.b7_no_break_primary_err_z); median(ii_results.b8_no_break_primary_err_z)];
dt_gain = [median(ii_results.b1_no_break_primary_gain_z); median(ii_results.b2_no_break_primary_gain_z); median(ii_results.b3_no_break_primary_gain_z); median(ii_results.b4_no_break_primary_gain_z); median(ii_results.b5_no_break_primary_gain_z); median(ii_results.b6_no_break_primary_gain_z); median(ii_results.b7_no_break_primary_gain_z); median(ii_results.b8_no_break_primary_gain_z)];
dt_srt = [median(ii_results.b1_no_break_srt); median(ii_results.b2_no_break_srt); median(ii_results.b3_no_break_srt); median(ii_results.b4_no_break_srt); median(ii_results.b5_no_break_srt); median(ii_results.b6_no_break_srt); median(ii_results.b7_no_break_srt); median(ii_results.b8_no_break_srt)];
...
putvar(ii_stats_vgs,ii_results);
end
