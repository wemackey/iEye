...
cmsg = sprintf('(Trial # %s) broke fixation', num2str(ii_cfg.tindex));
disp(cmsg);
putvar(ii_stats);
...
ii_stats(r).trial_compliance = trial_compliance;
cmsg = sprintf('(Trial # %s) blinked during cue presentation', num2str(ii_cfg.tindex));
disp(cmsg);
putvar(ii_stats);
...
ii_stats(r).trial_compliance = trial_compliance;
cmsg = sprintf('(Trial # %s) blinked during saccade', num2str(ii_cfg.tindex));
disp(cmsg);
putvar(ii_stats);
